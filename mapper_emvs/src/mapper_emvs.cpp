...
void MapperEMVS::FitPlanetoPC(PointCloud::Ptr cloud_filtered, PointCloud::Ptr cloud_p, pcl::ModelCoefficients::Ptr coefficients)
{
...
void MapperEMVS::PlaneRotationVector(pcl::ModelCoefficients::Ptr coefficients, geometry_utils::Transformation last_pose, Eigen::Vector4f& Quat)
{
...
void MapperEMVS::PlaneinInertial(PointCloud::Ptr cloud_filtered, geometry_utils::Transformation last_pose, Eigen::Vector4f Quat, Eigen::Vector4d& pcinInertialFrame, Eigen::Vector4f& PlaneQuatInertial)
{
  ...
  pcinCamFrame[0] = cloud_filtered->points[1].x;
  pcinCamFrame[1] = cloud_filtered->points[1].y;
  pcinCamFrame[2] = cloud_filtered->points[1].z;
  pcinCamFrame[3] = 1.0;
